 ...
 */
const host = "api";
const localServer = "https://www.gdutzuo.top:7080/pwa-server";
...
export default {
     ...
     * 获取用户信息
     */
    getUserInfo: `${host}/user/getInfo.do`,

    addExerciseLog:`${localServer}/exercise/addLog.do`,
    addQuestionLog:`${localServer}/questionLog/addLog.do`,
    analysisQuestion:`${localServer}/questionLog/analysis.do`,
    getpaperInfoByPlanId:`${localServer}/paperAnalysis/paperInfo.do`,
    submitPaper: `${localServer}/exercise/updateLog.do`,
